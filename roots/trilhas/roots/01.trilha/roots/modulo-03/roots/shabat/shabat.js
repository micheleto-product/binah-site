...
const LESSON_KEY = "binah_lesson_09_shabat";
...
function initQuiz() {
    ...
    form.addEventListener("submit", (e) => {
        ...
        if (selected.value === "3") {
            ...
            result.innerHTML =
                "✓ Correto! A Mishná lista 39 categorias de melachá, baseadas na construção do Tabernáculo.";
