...
const LESSON_KEY = "binah_lesson_10_kashrut";
...
/* ========================================= */
/* QUIZ - Categoria neutra */
/* Resposta correta: "Pareve" */
/* ========================================= */
...
function initQuiz() {
    ...
    form.addEventListener("submit", (e) => {
        ...
        if (selected.value === "2") {
            ...
            result.innerHTML =
                "✓ Correto! Alimentos pareve são neutros e podem acompanhar carne ou leite.";
