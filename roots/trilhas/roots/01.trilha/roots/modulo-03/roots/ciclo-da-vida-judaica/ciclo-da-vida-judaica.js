/* ========================================= */
/* BINAH - LIÇÃO: CICLO DA VIDA JUDAICA */
/* ========================================= */
...
const LESSON_KEY = "binah_lesson_12_ciclo_da_vida";
...
/* ========================================= */
/* QUIZ - Idade do Bar Mitzvá */
/* Resposta correta: "13 anos" */
/* ========================================= */
...
function initQuiz() {
    ...
    form.addEventListener("submit", (e) => {
        ...
        if (selected.value === "2") {
            ...
            result.innerHTML =
                "✓ Correto! O Bar Mitzvá ocorre tradicionalmente aos 13 anos.";
