...
const LESSON_KEY = "binah_lesson_16_chanuca";
...
/* ========================================= */
/* QUIZ - Duração de Chanucá */
/* Resposta correta: "8 dias" */
/* ========================================= */
...
function initQuiz() {
    ...
    form.addEventListener("submit", (e) => {
        ...
        if (selected.value === "3") {
            ...
            result.innerHTML =
                "✓ Correto! Chanucá dura oito noites, em referência ao milagre do óleo.";
