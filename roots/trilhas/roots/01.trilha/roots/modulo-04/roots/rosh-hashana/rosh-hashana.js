...
const LESSON_KEY = "binah_lesson_13_rosh_hashana";
...
/* ========================================= */
/* QUIZ - Instrumento de Rosh Hashaná */
/* Resposta correta: "Shofar" */
/* ========================================= */
...
function initQuiz() {
    ...
    form.addEventListener("submit", (e) => {
        ...
        if (selected.value === "2") {
            ...
            result.innerHTML =
                "✓ Correto! O shofar é soado em padrões específicos durante Rosh Hashaná.";
