...
const LESSON_KEY = "binah_lesson_17_purim";
...
/* ========================================= */
/* QUIZ - Livro lido em Purim */
/* Resposta correta: "Livro de Ester" */
/* ========================================= */
...
function initQuiz() {
    ...
    form.addEventListener("submit", (e) => {
        ...
        if (selected.value === "2") {
            ...
            result.innerHTML =
                "✓ Correto! O Livro de Ester é lido em voz alta durante Purim.";
