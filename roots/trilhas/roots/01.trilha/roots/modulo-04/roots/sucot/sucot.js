...
const LESSON_KEY = "binah_lesson_15_sucot";
...
/* ========================================= */
/* QUIZ - Quatro Espécies */
/* Resposta correta: "Lulav, Hadass, Aravá e Etrog" */
/* ========================================= */
...
function initQuiz() {
    ...
    form.addEventListener("submit", (e) => {
        ...
        if (selected.value === "2") {
            ...
            result.innerHTML =
                "✓ Correto! Lulav, Hadass, Aravá e Etrog formam as Quatro Espécies de Sucot.";
