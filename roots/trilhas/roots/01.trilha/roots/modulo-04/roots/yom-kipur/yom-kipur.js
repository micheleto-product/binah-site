...
const LESSON_KEY = "binah_lesson_14_yom_kipur";
...
/* ========================================= */
/* QUIZ - Duração do jejum */
/* Resposta correta: "25 horas" */
/* ========================================= */
...
function initQuiz() {
    ...
    form.addEventListener("submit", (e) => {
        ...
        if (selected.value === "3") {
            ...
            result.innerHTML =
                "✓ Correto! O jejum de Yom Kipur dura aproximadamente 25 horas.";
