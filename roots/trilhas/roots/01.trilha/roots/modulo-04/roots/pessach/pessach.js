...
const LESSON_KEY = "binah_lesson_18_pessach";
...
/* ========================================= */
/* QUIZ - Substituto do pão fermentado */
/* Resposta correta: "Matzá" */
/* ========================================= */
...
function initQuiz() {
    ...
    form.addEventListener("submit", (e) => {
        ...
        if (selected.value === "2") {
            ...
            result.innerHTML =
                "✓ Correto! A matzá substitui o pão fermentado durante todo o Pessach.";
