...
const LESSON_KEY = "binah_hebraico_lesson_03_escrita";
...
function initQuiz() {
    ...
    form.addEventListener("submit", e => {
        ...
        if (sel.value === "3") {
            result.innerHTML = "✓ Correto! Ktiv chaser é a escrita padrão sem marcação de vogais.";
