...
const LESSON_KEY = "binah_historia_lesson_11_sionismo";
...
/* ========================================= */
/* QUIZ - Organizador do Congresso de Basel */
/* Resposta correta: "Theodor Herzl" */
/* ========================================= */
...
function initQuiz() {
    ...
    form.addEventListener("submit", (e) => {
        ...
        if (selected.value === "2") {
            ...
            result.innerHTML =
                "✓ Correto! Theodor Herzl organizou o Primeiro Congresso Sionista, em Basel.";
