/* ========================================= */
/* BINAH - LIÇÃO: ISRAEL CONTEMPORÂNEO */
/* ========================================= */
...
const LESSON_KEY = "binah_historia_lesson_14_israel_contemporaneo";
...
function initQuiz() {
    ...
    form.addEventListener("submit", (e) => {
        ...
        if (selected.value === "2") {
            ...
            result.innerHTML =
                "✓ Correto! O Knesset tem 120 membros, eleitos por representação proporcional.";
