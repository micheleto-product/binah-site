...
const LESSON_KEY = "binah_historia_lesson_13_criacao_de_israel";
...
/* ========================================= */
/* QUIZ - Ano da declaração do Estado de Israel */
/* Resposta correta: "1948" */
/* ========================================= */
...
function initQuiz() {
    ...
    form.addEventListener("submit", (e) => {
        ...
        if (selected.value === "3") {
            ...
            result.innerHTML =
                "✓ Correto! O Estado de Israel foi declarado em 14 de maio de 1948.";
