...
const LESSON_KEY = "binah_historia_lesson_12_holocausto";
...
/* ========================================= */
/* QUIZ - Número aproximado de vítimas */
/* Resposta correta: "6 milhões" */
/* ========================================= */
...
function initQuiz() {
    ...
    form.addEventListener("submit", (e) => {
        ...
        if (selected.value === "3") {
            ...
            result.innerHTML =
                "✓ Correto! Estima-se que cerca de seis milhões de judeus foram assassinados no Holocausto.";
