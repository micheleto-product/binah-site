...
const LESSON_KEY = "binah_historia_lesson_05_retorno_do_exilio";
...
/* ========================================= */
/* QUIZ - Império que permitiu o retorno */
/* Resposta correta: "Persa" */
/* ========================================= */
...
function initQuiz() {
    ...
    form.addEventListener("submit", (e) => {
        ...
        if (selected.value === "2") {
            ...
            result.innerHTML =
                "✓ Correto! O decreto de Ciro, imperador persa, permitiu o retorno dos judeus.";
