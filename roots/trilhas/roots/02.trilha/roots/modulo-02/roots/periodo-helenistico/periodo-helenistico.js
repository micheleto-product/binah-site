/* ========================================= */
/* BINAH - LIÇÃO: PERÍODO HELENÍSTICO */
/* ========================================= */
...
const LESSON_KEY = "binah_historia_lesson_06_periodo_helenistico";
...
/* ========================================= */
/* QUIZ - Rei selêucida da Revolta dos Macabeus */
/* Resposta correta: "Antíoco IV" */
/* ========================================= */
...
function initQuiz() {
    ...
    form.addEventListener("submit", (e) => {
        ...
        if (selected.value === "3") {
            ...
            result.innerHTML =
                "✓ Correto! Antíoco IV provocou a Revolta dos Macabeus ao profanar o Templo.";
