...
const LESSON_KEY = "binah_historia_lesson_03_reino_de_israel";
...
/* ========================================= */
/* QUIZ - Construtor do Primeiro Templo */
/* Resposta correta: "Salomão" */
/* ========================================= */
...
function initQuiz() {
    ...
    form.addEventListener("submit", (e) => {
        ...
        if (selected.value === "3") {
            ...
            result.innerHTML =
                "✓ Correto! Salomão é tradicionalmente associado à construção do Primeiro Templo.";
