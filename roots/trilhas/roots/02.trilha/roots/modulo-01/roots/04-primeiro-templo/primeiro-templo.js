...
const LESSON_KEY = "binah_historia_lesson_04_primeiro_templo";
...
/* ========================================= */
/* QUIZ - Ano da destruição do Primeiro Templo */
/* Resposta correta: "586 a.E.C." */
/* ========================================= */
...
function initQuiz() {
    ...
    form.addEventListener("submit", (e) => {
        ...
        if (selected.value === "2") {
            ...
            result.innerHTML =
                "✓ Correto! O Primeiro Templo foi destruído pelos babilônios em 586 a.E.C.";
