...
const LESSON_KEY = "binah_historia_lesson_02_exodo";
...
/* ========================================= */
/* QUIZ - Onde a Torá foi entregue */
/* Resposta correta: "Monte Sinai" */
/* ========================================= */
...
function initQuiz() {
    ...
    form.addEventListener("submit", (e) => {
        ...
        if (selected.value === "2") {
            ...
            result.innerHTML =
                "✓ Correto! A Torá foi revelada no Monte Sinai, segundo a tradição.";
