...
const LESSON_KEY = "binah_historia_lesson_09_idade_media";
...
/* ========================================= */
/* QUIZ - Região da Era de Ouro */
/* Resposta correta: "Al-Andalus" */
/* ========================================= */
...
function initQuiz() {
    ...
    form.addEventListener("submit", (e) => {
        ...
        if (selected.value === "2") {
            ...
            result.innerHTML =
                "✓ Correto! Al-Andalus, sob domínio muçulmano, viveu a chamada 'Era de Ouro'.";
