/* ========================================= */
/* BINAH - LIÇÃO: COMUNIDADES JUDAICAS */
/* ========================================= */
...
const LESSON_KEY = "binah_historia_lesson_08_comunidades_judaicas";
...
/* ========================================= */
/* QUIZ - Líder da comunidade na Babilônia */
/* Resposta correta: "Exilarca (Rosh Golá)" */
/* ========================================= */
...
function initQuiz() {
    ...
    form.addEventListener("submit", (e) => {
        ...
        if (selected.value === "2") {
            ...
            result.innerHTML =
                "✓ Correto! O Exilarca (Rosh Golá) liderava a comunidade judaica na Babilônia.";
