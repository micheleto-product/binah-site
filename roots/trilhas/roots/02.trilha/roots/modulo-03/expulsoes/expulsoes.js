...
const LESSON_KEY = "binah_historia_lesson_10_expulsoes";
...
/* ========================================= */
/* QUIZ - Ano da expulsão da Espanha */
/* Resposta correta: "1492" */
/* ========================================= */
...
function initQuiz() {
    ...
    form.addEventListener("submit", (e) => {
        ...
        if (selected.value === "3") {
            ...
            result.innerHTML =
                "✓ Correto! O Decreto de Alhambra expulsou os judeus da Espanha em 1492.";
