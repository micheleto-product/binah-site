/* ========================================= */
/* BINAH - LIÇÃO: VAYIKRA — ESTUDO DO LIVRO */
/* ========================================= */
...
const LESSON_KEY = "binah_tora_lesson_06_vayikra_estudo";
...
/* ========================================= */
/* QUIZ - Capítulo do "ama o teu próximo" */
/* Resposta correta: "Capítulo 19" */
/* ========================================= */
...
function initQuiz() {
    ...
    form.addEventListener("submit", (e) => {
        ...
        if (selected.value === "4") {
            ...
            result.innerHTML =
                "✓ Correto! 'Ama o teu próximo como a ti mesmo' está em Levítico 19:18.";
