/* ========================================= */
/* BINAH - LIÇÃO: BAMIDBAR — ESTUDO DO LIVRO */
/* ========================================= */
...
const LESSON_KEY = "binah_tora_lesson_07_bamidbar_estudo";
...
/* ========================================= */
/* QUIZ - Número de capítulos de Bamidbar */
/* Resposta correta: "36" */
/* ========================================= */
...
function initQuiz() {
    ...
    form.addEventListener("submit", (e) => {
        ...
        if (selected.value === "3") {
            ...
            result.innerHTML =
                "✓ Correto! Bamidbar tem 36 capítulos e 10 parashot.";
