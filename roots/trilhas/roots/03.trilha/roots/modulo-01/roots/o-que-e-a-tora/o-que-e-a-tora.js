...
const LESSON_KEY = "binah_tora_lesson_01_o_que_e";
...
/* ========================================= */
/* QUIZ - Sentido original de "Torá" */
/* Resposta correta: "Instrução" */
/* ========================================= */
...
function initQuiz() {
    ...
    form.addEventListener("submit", (e) => {
        ...
        if (selected.value === "2") {
            ...
            result.innerHTML =
                "✓ Correto! Torá significa, originalmente, 'instrução' ou 'ensinamento'.";
