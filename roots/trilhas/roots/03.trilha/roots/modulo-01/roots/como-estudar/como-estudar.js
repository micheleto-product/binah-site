...
const LESSON_KEY = "binah_tora_lesson_03_como_estudar";
...
/* ========================================= */
/* QUIZ - Nível literal do PaRDeS */
/* Resposta correta: "Pshat" */
/* ========================================= */
...
function initQuiz() {
    ...
    form.addEventListener("submit", (e) => {
        ...
        if (selected.value === "1") {
            ...
            result.innerHTML =
                "✓ Correto! Pshat é o sentido simples e literal do texto.";
