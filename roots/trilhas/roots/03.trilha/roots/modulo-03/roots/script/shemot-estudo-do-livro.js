/* ========================================= */
/* BINAH - LIÇÃO: SHEMOT — ESTUDO DO LIVRO */
/* ========================================= */
...
const LESSON_KEY = "binah_tora_lesson_05_shemot_estudo";
...
/* ========================================= */
/* QUIZ - Número de capítulos de Shemot */
/* Resposta correta: "40" */
/* ========================================= */
...
function initQuiz() {
    ...
    form.addEventListener("submit", (e) => {
        ...
        if (selected.value === "3") {
            ...
            result.innerHTML =
                "✓ Correto! Shemot tem 40 capítulos e 11 parashot.";
