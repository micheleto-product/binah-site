/* ========================================= */
/* BINAH - LIÇÃO: DEVARIM — ESTUDO DO LIVRO */
/* ========================================= */
...
const LESSON_KEY = "binah_tora_lesson_08_devarim_estudo";
...
/* ========================================= */
/* QUIZ - Onde o Shemá aparece */
/* Resposta correta: "Devarim" */
/* ========================================= */
...
function initQuiz() {
    ...
    form.addEventListener("submit", (e) => {
        ...
        if (selected.value === "4") {
            ...
            result.innerHTML =
                "✓ Correto! O Shemá Israel aparece em Devarim 6:4.";
