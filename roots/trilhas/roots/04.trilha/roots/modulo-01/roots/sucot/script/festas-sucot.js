...
const LESSON_KEY = "binah_festas_lesson_03_sucot";
...
/* Resposta correta: "Etrog" (value 2) */
...
function initQuiz() {
    ...
    form.addEventListener("submit", e => {
        ...
        if (selected.value === "2") {
            ...
            result.innerHTML = "✓ Correto! O etrog tem tanto gosto quanto cheiro.";
