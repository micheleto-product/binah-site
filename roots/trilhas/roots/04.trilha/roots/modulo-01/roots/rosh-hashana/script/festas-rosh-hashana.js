/* ========================================= */
/* BINAH - LIÇÃO: ROSH HASHANÁ (FESTAS) */
/* ========================================= */
...
const LESSON_KEY = "binah_festas_lesson_01_rosh_hashana";
...
/* Resposta correta: "Tekiá Guedolá" (value 4) */
...
function initQuiz() {
    ...
    form.addEventListener("submit", e => {
        ...
        if (selected.value === "4") {
            ...
            result.innerHTML = "✓ Correto! Tekiá Guedolá é o som longo estendido que encerra a sequência.";
