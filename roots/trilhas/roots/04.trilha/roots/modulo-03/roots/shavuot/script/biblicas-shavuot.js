/* ========================================= */
/* BINAH - LIÇÃO: SHAVUOT (FESTAS BÍBLICAS) */
/* ========================================= */
...
const LESSON_KEY = "binah_festas_lesson_08_biblicas_shavuot";
...
function initQuiz() {
    ...
    form.addEventListener("submit", e => {
        ...
        if (selected.value === "3") {
            ...
            result.innerHTML = "✓ Correto! Rute representa a aceitação voluntária da Aliança — e a história se passa na colheita.";
