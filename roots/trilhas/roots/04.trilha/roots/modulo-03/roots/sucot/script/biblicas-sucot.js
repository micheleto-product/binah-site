/* ========================================= */
/* BINAH - LIÇÃO: SUCOT (FESTAS BÍBLICAS) */
/* ========================================= */
...
const LESSON_KEY = "binah_festas_lesson_09_biblicas_sucot";
...
/* Resposta correta: "Kohelet" (value 2) */
...
function initQuiz() {
    ...
    form.addEventListener("submit", e => {
        ...
        if (selected.value === "2") {
            ...
            result.innerHTML = "✓ Correto! Kohelet reflete sobre transitoriedade — em diálogo direto com a sucá temporária.";
