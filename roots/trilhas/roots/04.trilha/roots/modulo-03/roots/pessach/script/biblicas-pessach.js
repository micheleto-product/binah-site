/* ========================================= */
/* BINAH - LIÇÃO: PESSACH (FESTAS BÍBLICAS) */
/* ========================================= */
...
const LESSON_KEY = "binah_festas_lesson_07_biblicas_pessach";
...
/* Resposta correta: "Maror" (value 3) */
...
function initQuiz() {
    ...
    form.addEventListener("submit", e => {
        ...
        if (selected.value === "3") {
            ...
            result.innerHTML = "✓ Correto! O maror (erva amarga) representa a amargura da escravidão.";
