/* ========================================= */
/* BINAH - LIÇÃO: PURIM (FESTAS HISTÓRICAS) */
/* ========================================= */
...
const LESSON_KEY = "binah_festas_lesson_05_purim";
...
/* Resposta correta: "Mishloach Manot" (value 3) */
...
function initQuiz() {
    ...
    form.addEventListener("submit", e => {
        ...
        if (selected.value === "3") {
            ...
            result.innerHTML = "✓ Correto! Mishloach Manot é o envio de alimentos a outras pessoas.";
