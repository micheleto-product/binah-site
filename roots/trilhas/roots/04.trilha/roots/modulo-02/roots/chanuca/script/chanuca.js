/* ========================================= */
/* BINAH - LIÇÃO: CHANUCÁ (FESTAS HISTÓRICAS) */
/* ========================================= */
...
const LESSON_KEY = "binah_festas_lesson_04_chanuca";
...
/* Resposta correta: "Em santidade, sempre se aumenta" (value 2) */
...
function initQuiz() {
    ...
    form.addEventListener("submit", e => {
        ...
        if (selected.value === "2") {
            ...
            result.innerHTML = "✓ Correto! Em matéria de santidade, sempre se aumenta — nunca se diminui.";
