/* ========================================= */
/* BINAH - LIÇÃO: LAG BAOMER (FESTAS HISTÓRICAS) */
/* ========================================= */
...
const LESSON_KEY = "binah_festas_lesson_06_lag_baomer";
...
/* Resposta correta: "49 dias" (value 3) */
...
function initQuiz() {
    ...
    form.addEventListener("submit", e => {
        ...
        if (selected.value === "3") {
            ...
            result.innerHTML = "✓ Correto! O Omer conta 49 dias — sete semanas completas.";
